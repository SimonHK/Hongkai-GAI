...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>GAI</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>GraphAI-JOB</b> ${I18n.admin_version}
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018-${.now?string('yyyy')} &nbsp;
                <a href="http://www.graphai.com/" target="_blank" >Graph AI</a>
				&nbsp;
                <a href="https://www.graphai.com/graphai-job" target="_blank" >Graph AI</a>

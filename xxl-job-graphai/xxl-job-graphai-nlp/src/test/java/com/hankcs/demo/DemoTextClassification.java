...
public class DemoTextClassification
{
     ...
     * 模型保存路径
     */
    public static final String MODEL_PATH = "/Users/hongkai/Development/GitHubSource/xxl-job/data/test/classification-model.ser";
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        predict(classifier,"中资金融机构的境外分支机构应当遵循.");
